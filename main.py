            ...
            try:
                await bot.send_message(
                    ...
                    text=(
                        ...
                        "Бот не опаздывает, бот задерживается) Бот готов принимать прогнозы на матч против Кальяри. Обратите внимание на Ваши прогнозы перестают приниматься ровно за 2 часа до начала матча.\n\n"
