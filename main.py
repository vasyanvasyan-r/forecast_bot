            ...
            try:
                await bot.send_message(
                    ...
                    text=(
                        ...
                        "Бот спешит и готов принимать прогнозы на матч чемпионата против Дженоа. Обратите внимание на Ваши прогнозы перестают приниматься ровно за 2 часа до начала матча.\n\n"
