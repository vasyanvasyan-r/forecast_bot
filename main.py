        ...
        for user_id in authorized_users:
            try:
                await bot.send_message(
                    chat_id=user_id,
                    text=(
                        "Добрый день, наш дорогой <b>Прогнозист</b>!\n"
                        "Бот готов принимать прогнозы на матч Лиги Европы против Болонья. Обратите внимание на Ваши прогнозы перестают приниматься ровно за 2 часа до начала матча.\n\n"
                        "Вопросы в боте касаются только основного времени. Все события после основного времени не идут в зачет и не берутся в расчет.\n\n"
