            ...
            try:
                await bot.send_message(
                    ...
                    text=(
                        ...
                        "Бот готов принимать прогнозы на матч против Пармы. Обратите внимание на Ваши прогнозы перестают приниматься ровно за 2 часа до начала матча.\n\n"

                        "После прошлого матча произошло разделение на претендентов и Топ-10, и теперь соревнование прогнозистов переходит, "
