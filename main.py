            ...
            try:
                await bot.send_message(
                    ...
                    text=(
                        ...
                        "Бот готов принимать прогнозы на матч чемпионата против Торино. Обратите внимание на Ваши прогнозы перестают приниматься ровно за 2 часа до начала матча.\n\n"
